...
class TestLaunchRoute(unittest.TestCase):
    ...
    @patch.object(UserService, 'get_role', return_value=["student"])
    def test_launch_right(self, mock_get_role):
        ...
        AuthJWT.create_access_token.assert_called_once_with(subject="localhost",
                                                            user_claims={"roles": ["student"], "launch_id": 123})
        AuthJWT.create_refresh_token.assert_called_once_with(subject="localhost",
                                                             user_claims={"roles": ["student"], "launch_id": 123})
